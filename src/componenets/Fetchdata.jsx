...
const Fetchdata = () => {
  ...
  const url ="https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=1f4be9a8bb504c7aa7ae920d3bb7b4fb"
  const [data, setdata] = useState([]);

  // const fetchdata = async () => {
  //   await axios
  //     .get(
  //       "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=1f4be9a8bb504c7aa7ae920d3bb7b4fb"
  //     )
